...
public class AOSPALActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.aospal_logo);
        ...
        String paVersion = SystemProperties.get("ro.psd.version");
        paVersion = paVersion.replaceAll("([0-9\\.]+?)-.*", "$1");
        tv.setText("Paranoid Saber Droid " + paVersion);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    intent.setClassName("com.android.settings", "com.android.settings.Nyandroid")
                          .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    getBaseContext().startActivityAsUser(intent,
                            new UserHandle(UserHandle.USER_CURRENT));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("AOSPALActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
