...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.ANIMATION_IME_DURATION), false, this);
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.ANIMATION_IME_ENTER), false, this);
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.ANIMATION_IME_EXIT), false, this);
            getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.ANIMATION_IME_INTERPOLATOR), false, this);
    ...
    private void updateSettings() {
        mAnimationEnterIndex = Settings.System.getInt(getContentResolver(), Settings.System.ANIMATION_IME_ENTER, 0);
        mAnimationExitIndex = Settings.System.getInt(getContentResolver(), Settings.System.ANIMATION_IME_EXIT, 0);
        mInterpolatorIndex = Settings.System.getInt(getContentResolver(), Settings.System.ANIMATION_IME_INTERPOLATOR, 0);
        int temp = Settings.System.getInt(getContentResolver(), Settings.System.ANIMATION_CONTROLS_DURATION, 500);
    ...
    public void updateFullscreenMode() {
        ...
        boolean fullScreenOverride = Settings.System.getIntForUser(getContentResolver(),
                Settings.System.DISABLE_FULLSCREEN_KEYBOARD, 1,
